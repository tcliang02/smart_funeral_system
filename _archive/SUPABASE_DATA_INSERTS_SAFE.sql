-- ========================================
-- SAFE DATA INSERTS for Supabase (Handles Existing Data)
-- This version will skip existing records and only add missing ones
-- ========================================
...
-- Insert booking_addons (THE MISSING DATA!)
...
-- Insert missing bookings (if any)
...
-- Re-enable RLS (optional - you can configure policies later)
...
-- Done! Missing data (especially booking_addons) should now be inserted.
